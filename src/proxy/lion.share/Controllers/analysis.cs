...
namespace Lion.Share.Controllers
{
    public class WinnerAnalysis
    {
        ...
        /// 1.홀짝 치우침
        /// </summary>
        private void EvenOddBalance(mAnalysis[] analysies, mAnalysis analysis, int sequence_no)
        {
        ...
        /// 2.고저 치우침
        /// </summary>
        private void HighLowBalance(mAnalysis[] analysies, mAnalysis analysis, int sequence_no)
        {
        ...
        /// 3.합계 치우침
        /// </summary>
        private void SumBalance(mAnalysis analysis)
        {
        ...
        /// 4.숫자 집단 치우침
        /// </summary>
        private void GroupBalance(mAnalysis analysis, short[] digits)
        {
            analysis.Group45 = 0;
            analysis.Group36 = 0;
            analysis.Group27 = 0;
        ...
        /// 5.HotCold 치우침
        /// </summary>
        private void HotColdCalc(mAnalysis[] analysies, mAnalysis analysis, short[] digits, int sequence_no)
        {
        ...
        private (short r, short m) WinnerNumberCount(mAnalysis[] analysies, short[] digits, int sequence_no, int depth)
        {
        ...
        /// 6.퍼센티지 계산
        /// </summary>
        private void PercentageCalc(mAnalysis[] analysies, mAnalysis analysis, short[] digits, int sequence_no)
        {
        ...
        /// 7.당첨 차트 계산
        /// </summary>
        private void WinerChart(mAnalysis[] analysies, mAnalysis analysis, short[] digits, int sequence_no)
        {
            for (var n = 1; n <= 6; n++)
            {
                var _count = 0;
        ...
        /// 8.합계빈도 확인
        /// </summary>
        private void ReviewFrequency(mAnalysis[] analysies, mAnalysis analysis, short[] digits, int sequence_no)
        {
        ...
        public mAnalysis AnalysisWinner(AppDbContext ltctx, mWinner[] winners, mAnalysis[] analysies, int analysis_no)
        {
            var _winner = winners[analysis_no - 1];

            var _analysis = new mAnalysis()
            {
