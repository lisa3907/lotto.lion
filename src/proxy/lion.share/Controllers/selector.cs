...
namespace Lion.Share.Controllers
{
    public partial class WinnerSelector
    {
        ...
        private short[] GetLNumbereByPercent(mAnalysis[] analysies, int sequence_no, int no_sampling)
        {
        ...
        private short[] GetRNumbereByPercent(mAnalysis[] analysies, int sequence_no, int no_sampling)
        {
            var _result = new List<short>();
        ...
        /// 1.홀짝 치우침
        /// </summary>
        private (short sum_odd, short sum_even) EvenOddBalance(mAnalysis[] analysies, int sequence_no)
        {
        ...
        /// 2.고저 치우침
        /// </summary>
        private (short sum_high, short sum_low) HighLowBalance(mAnalysis[] analysies, int sequence_no)
        {
        ...
        private bool Filtering(dFilter filter, short[] digits)
        {
            // 홀짝 확인
            var _odd_even = 0;
            {
        ...
        private (int no_select, int no_combine) WinnerElect(AppDbContext ltctx, dFilter filter)
        {
        ...
        private void WinnerShuffle(dFilter filter)
        {
        ...
        private int WinnerWrite(AppDbContext ltctx, dFilter filter)
        {
            var _result = 0;
            ...
            foreach (var _d in filter.elects)
            {
                ...
                ltctx.tb_lion_select.Add(_select);
